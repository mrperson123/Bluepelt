                        ...
                        foreach($aSkills as $aSkill){
                            ...
                            <div class="sheet-skill">
                                <span class="sheet-skill-name">
                                    <?php echo $Skill["name"]; ?> <?php echo $cXp->SkillCounter($aSkill["skill_points"]); ?>
                                    <?php 
                        ...
                        foreach($aBackgrounds as $aBackground){
                            ...
                            <div class="sheet-background">
                                <span class="sheet-background-name">
                                    <?php echo $background["name"]; ?> <?php echo $cXp->BackgroundCounter($aBackground["background_points"]); ?>
                                    <?php 
                ...
                <div class="column col4">
                    ...
                    <?php 
                        ...
                        <div class="sheet-gift">
                            <span class="sheet-gift-name"><?php echo $aGift["name"]; ?> <pre></pre><?php  echo $cXp->GiftCounter($aGift["id"], $aCharacter); ?></pre></span> <?php echo $aGift["level"]; ?>
                        </div>
                        <?php
